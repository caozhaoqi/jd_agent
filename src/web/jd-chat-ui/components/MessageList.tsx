...
import { Bot, User, Play, LayoutDashboard, Copy, Download } from "lucide-react";
...
useEffect(() => {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-6 scroll-smooth relative bg-[#f8fafc]">
      {/* 复制成功提示 */}
      {copySuccess && (
        <div className="fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg animate-in fade-in duration-300 z-50">
          {copySuccess}
        </div>
      )}
