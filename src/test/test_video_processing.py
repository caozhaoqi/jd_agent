...
class TestVideoUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            # 创建一个10秒的空白视频
            (ffmpeg
             .input('anullsrc', format='lavfi', t=10)
             .input('color=black:640x480:r=25', format='lavfi', t=10)
             .output(self.test_video_path, vcodec='libx264', acodec='aac', shortest=None)
             .overwrite_output()
    ...
    def test_list_video_files(self):
        ...
        # 检查结果
        expected_videos = [os.path.join(self.test_dir, "video1.mp4"), os.path.join(self.test_dir, "video2.avi")]
