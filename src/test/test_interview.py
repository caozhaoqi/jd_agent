...
@patch('app.services.interview_service.generate_interview_guide', new_callable=AsyncMock)
def test_create_guide(mock_generate, client: TestClient, test_user: User, test_token: str, mock_jd_text: str):
    """测试创建面试指南接口"""
    # 准备模拟返回值
    mock_report = InterviewReport(
        ...
        tech_questions=[{"question": "什么是FastAPI？", "answer": "FastAPI是一个现代、快速的Web框架", "category": "技术问题", "reference_answer": "FastAPI是一个现代、快速的Web框架"}],
        hr_questions=[{"question": "你为什么想加入我们公司？", "answer": "我对贵公司的技术栈很感兴趣", "category": "HR问题", "reference_answer": "我对贵公司的技术栈很感兴趣"}],
...
def test_stream_generate_guide(mock_ainvoke, client: TestClient, test_user: User, test_token: str, mock_jd_text: str):
    """测试流式生成面试指南接口"""
    # 准备模拟返回值
    mock_final_state = {
        "company_name": "科技有限公司",
        "tech_stack": ["Python", "FastAPI"],
        "years_required": "5年以上",
        "tech_questions": [{"question": "什么是FastAPI？", "answer": "FastAPI是一个现代、快速的Web框架"}],
        "hr_questions": [{"question": "你为什么想加入我们公司？", "answer": "我对贵公司的技术栈很感兴趣"}],
        "company_analysis": "这是一家科技公司"
    }
...
def test_stream_mock_interview(mock_run_mock, client: TestClient, test_user: User, test_token: str, mock_jd_text: str):
    """测试流式模拟面试接口"""
    # 准备模拟返回值
