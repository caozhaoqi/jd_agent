...
from app.api.routers import auth, resume, chat, interview, audio, rag, webrtc, jd, video_analysis, confluence
...
api_router.include_router(interview.router, prefix="/interview", tags=["Interview"])  # 包含 /generate-guide, /agent/feedback 等
